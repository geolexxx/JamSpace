...
import { ColumnBuilder, type InferTypeOfRow, type TypeBuilder } from './type_builders';
import { Uuid } from './uuid.ts';
/**
 * Helper to extract the parameter types from an object type
 */
export type ParamsObj = Record<string, TypeBuilder<any, any> | ColumnBuilder<any, any, any>>;
/**
 * Helper to convert a ParamsObj or RowObj into an object type
 */
export type ParamsAsObject<ParamDef extends ParamsObj> = InferTypeOfRow<ParamDef>;
/**
 ...
 * ```
 */
export type Reducer<S extends UntypedSchemaDef, Params extends ParamsObj> = (ctx: ReducerCtx<S>, payload: ParamsAsObject<Params>) => void;
/**
