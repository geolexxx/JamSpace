...
import { CaseConversionPolicy, type MethodOrAny } from '../lib/autogen/types';
...
import { Router, type HandlerFn, type HttpHandlerExport, type HttpHandlerOpts } from './http_handlers';
...
import { type AnonViews, type AnonymousViewFn, type ViewExport, type ViewFn, type ViewOpts, type ViewReturnTypeBuilder, type ValidateViewPrimaryKey, type Views } from './views';
export declare class SchemaInner<S extends UntypedSchemaDef = UntypedSchemaDef> extends ModuleContext {
    ...
    existingHttpHandlers: Set<string>;
    reducers: Reducers;
    ...
    defineHttpHandler(name: string): void;
    resolveSchedules(): void;
    resolveHttpRoutes(): void;
}
...
export declare class Schema<S extends UntypedSchemaDef> implements ModuleDefaultExport {
    ...
    view<Ret extends ViewReturnTypeBuilder, F extends ViewFn<S, {}, Ret>>(opts: ViewOpts, ret: Ret, fn: F, ..._: ValidateViewPrimaryKey<Ret>): ViewExport<F>;
    anonymousView<Ret extends ViewReturnTypeBuilder, F extends AnonymousViewFn<S, {}, Ret>>(opts: ViewOpts, ret: Ret, fn: F, ..._: ValidateViewPrimaryKey<Ret>): ViewExport<F>;
