...
var WebsocketDecompressAdapter = (_a10 = class {
  ...
  static async openWebSocket(args) {
    return new _a10(await openWebSocket(args));
  }
...
var DbConnectionBuilder = (_a11 = class {
  ...
  getUri() {
    var _a16;
    return ((_a16 = __privateGet(this, _uri)) == null ? void 0 : _a16.toString()) ?? "";
  }
  getModuleName() {
  ...
  build() {
    ...
    ensureMinimumVersionOrThrow((_a16 = this.remoteModule.versionInfo) == null ? void 0 : _a16.cliVersion);
...
var SubscriptionBuilderImpl = (_a12 = class {
  ...
  subscribe(query_sql) {
    ...
    if (typeof query_sql === "function") {
      const tablesMap = (_b3 = (_a16 = this.db).getTablesMap) == null ? void 0 : _b3.call(_a16);
...
mergeTableUpdates_fn = function(updates) {
  ...
  __privateMethod(this, _DbConnectionImpl_instances, sendEncodedMessage_fn).call(this, encoded, () => isLive ? `Sending message to server: ${stringify2(message)}` : `Queuing message to server: ${stringify2(message)}`);
